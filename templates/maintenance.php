<?php
    ...
    wp_enqueue_script('simplyCountdown', MAGURA_2025_THEME_URL . '/assets/js/simplyCountdown/simplyCountdown.umd.js');

    wp_enqueue_style('simplyCountdown', MAGURA_2025_THEME_URL . '/assets/js/simplyCountdown/themes/default.css');
        ...
        <div class="content-box content-centered">
            <div class="maintenance-content">
                <div class="maintenance-content-text">
                    ...
                    <h1>Suntem la o îmbrățișare distanță de o nouă călătorie Măgura. Ne revedem în curând!</h1>
